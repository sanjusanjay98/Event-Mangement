...
<head>
    ...
    <title>User Registration - EventManager</title>
    ...
    <style>
        ...
        * {
        ...
        .form-control {
            ...
            color: white;
            font-size: 16px;
            padding: 22px 60px 22px 24px; /* Fixed padding for icon space */
        ...
        .register-btn:hover {
            ...
            box-shadow: 0 25px 45px rgba(67, 233, 123, 0.4);
        }
    ...
    <div class="register-container">
        <div class="register-card">
            <div class="brand">
                ...
                <h2>Join EventManager</h2>
                <p>Start your journey with amazing events</p>
            </div>
            ...
            <form action="newuserdata" method="post" id="registerForm">
            ...
            function getPasswordStrength(password) {
                ...
                const levels = [
                    ...
                    { 
                        ...
                        color: '#ffcd00', 
                        gradient: 'linear-gradient(90deg, #ffcd00 0%, #43e97b 100%)',
                        percentage: 60,
                    ...
                    { 
                        ...
                        text: 'Good - Well done!', 
                        color: '#7ed321', 
                        gradient: 'linear-gradient(90deg, #7ed321 0%, #43e97b 100%)',
                        percentage: 80,
